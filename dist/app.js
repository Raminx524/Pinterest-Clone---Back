...
const pinRoute_1 = __importDefault(require("./routes/pinRoute")); // Adjust path if necessary
const boardRoute_1 = __importDefault(require("./routes/boardRoute")); // Adjust path if necessary
const likeRoute_1 = __importDefault(require("./routes/likeRoute"));
const commentRoute_1 = __importDefault(require("./routes/commentRoute"));
// import commentRoute from "./routes/commentRoute"; // Adjust path if necessary
